...
class ProductoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $productos = Producto::getProductsList($nproducto, $ncategoria, $estado);

        if ($request->ajax()):
            return view('admin.data.productos-data', compact('productos', 'productos'));
        endif;
    ...
    public function create()
    {
        ...
        return view('admin.modules.crud-productos', compact('categorias'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()):
            ...
            $data = ProductoService::ArrayProductoAdd($request, $filename);
    ...
    public function edit(string $producto_id)
    {
        ...
        return view('admin.modules.crud-productos', compact('producto', 'categorias', 'producto_id'));
    }
    ...
    public function update(Request $request, string $producto_id)
    {
        ...
        if($validator->fails()):
            ...
            $data = ProductoService::ArrayProductoUpdate($request, $filename);
