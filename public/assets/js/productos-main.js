...
function loadproductos(page)
{
    ...
    url=$('meta[name=app-url]').attr("content")  + "/user" + "/productos?page="+page;
...
{
    const url=$('meta[name=app-url]').attr("content") + "/user" + "/productos";
    $.ajax({
        headers: 
        {
...
window.desactivarProducto = function(producto_id)
{
    Swal.fire({
            ...
            cancelButtonText: `Cancelar`,
                ...
                if (result.isConfirmed) {
                    let url = $('meta[name=app-url]').attr("content") +  "/user" + "/productos" +  "/desactivar/" + producto_id;
                    let data = {
                        producto_id: producto_id
                    };
                    $.ajax({
...
window.activarProducto = function(producto_id)
{
    Swal.fire({
            ...
            cancelButtonText: `Cancelar`,
                ...
                if (result.isConfirmed) {
                    let url = $('meta[name=app-url]').attr("content") +  "/user" + "/productos" +  "/activar/" + producto_id;
                    let data = {
                        producto_id: producto_id
                    };
                    $.ajax({
