<div class="table-responsive">
            ...
            @if(count($usuarios) > 0)
                ...
                <?php $encrypUserId=Hashids::encode($usu->user_id);?>
                    <tr>
                        ...
                        <td>{{ $usu->rol}}</td>
                        @if($usu->foto!= '')
                        <td><img src="{{URL::asset($usu->foto)}}" class="img-fluid" width="80" alt="Foto Usuario"></td>
                        @else 
                        <td><img src="{{URL::asset('admin_assets/images/usuarios/default.png')}}" class="img-fluid" width="80" alt="Foto Usuario"></td>
                        @endif
    ...
    {{ $usuarios->onEachSide(1)->links('users.partials.my-paginate') }}
